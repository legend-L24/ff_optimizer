...
def generate_config(ff_path=ff_path, copy_from_remote="Movies/System_0/", dest_path=dest_path, exp_path=experiment_path, Number_points=Number_points, path = "/home/yutao/project/aiida/applications/config.py"):
...
def sample():
    generate_config() 
    command = ["/home/yutao/project/aiida/applications/sample_workflow.sh"]
