...
structure_folder = "/home/yutao/project/Cu-MOF/MOF-602/"
experiment_path = os.path.join(structure_folder, "273K.csv")
cif_path = os.path.join(structure_folder, "RSM2539.cif")
dest_path = "/home/yutao/project/MIL-120/traj14/"
copy_to_path = "./traj14/"
ff_path = '/home/yutao/project/aiida/applications/ff_14.json'
Transfer_unit = 10.0885500000/5.0983969101 #It also depends on different structure, it also contains transfer from STP to mol/Kg
SET_temperature = 273
...
xmlio.loadXML("data/init_Cu.xml")
...
optimizer = optax.adam(0.015)
opt_state = optimizer.init(paramset)

os.system(f"cp /home/yutao/project/aiida/applications/UFF_Cu.json {ff_path}")
